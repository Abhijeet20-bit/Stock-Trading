...
public class BuyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        result=sn.getAllNames();
        if(result!=null) 
        {
            String SYM = request.getParameter("sym");
            request.setAttribute("param",SYM);
            request.setAttribute("param2",result.get(SYM));
            request.setAttribute("BuySelect",result);
            RequestDispatcher rd=request.getRequestDispatcher("/Buy.jsp");
            rd.forward(request, response);
        }
        else
        {
            response.sendRedirect("/StockTrading/Error.jsp?msg=No Stock to display Available");
        }
